"""
Django settings for dbiere project.
...
WSGI_APPLICATION = 'dbiere.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'dbiere/static')
]
...
REST_FRAMEWORK = {
    ...
    # To suppress the human-readable API pages and just use JSON
